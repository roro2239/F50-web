...
//      this.f_width = this.form_field_jq.outerWidth();
      this.f_width = this.options.width == '100%' ? '100%' : this.options.width.replace(/\D/g, '');//PX-867
      container_props = {
        id: this.container_id,
        "class": container_classes.join(' '),
        style: this.f_width == '100%' ? 'width: 100%' : 'width: ' + this.f_width + 'px;',
        title: this.form_field.title
      };
      container_div = $("<div />", container_props);
      if (this.is_multiple) {
        container_div.html('<ul class="chzn-choices"><li class="search-field"><input type="text" id="chosen-search-field-input" maxlength="40" data-trans="select_some_options" value="' + $.i18n.prop('select_some_options') + '" class="default" autocomplete="off" style="width:25px;" /></li></ul><div class="chzn-drop" style="left:-9000px; width:100%;"><ul class="chzn-results"></ul></div>');
      } else {
        container_div.html('<a href="javascript:void(0)" class="chzn-single chzn-default"><span>' + $.i18n.prop('select_some_options') + '</span><div><b></b></div></a><div class="chzn-drop" style="left:-9000px; width:100%;"><div class="chzn-search"><input type="text" autocomplete="off" /></div><ul class="chzn-results"></ul></div>');
      }
